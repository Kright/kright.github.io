---
lang: en
ref: delaiu-svoi-iazyk-programmirovaniia
redirect_from:
  - /2026/07/06/%D0%94%D0%B5%D0%BB%D0%B0%D1%8E-%D1%81%D0%B2%D0%BE%D0%B9-%D1%8F%D0%B7%D1%8B%D0%BA-%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F-en.html
permalink: /2026/07/06/delaiu-svoi-iazyk-programmirovaniia-en/
...
For several years I'd been slowly writing down all sorts of interesting thoughts and ideas about programming languages. If you're curious, they're here: ["On programming language design"](/2024/03/11/o-dizaine-iazykov-programmirovaniia-en/)
...
* Optional GC: languages often come in pairs (for example, high-level Python and low-level libraries with a C interface to go with it, or for example the JVM for java is written in C++). And it turns out there's a hard boundary between a language with GC and one without - different languages, different syntax, different type systems. You can't just take a hot loop in Java/Python and rewrite that piece in C++. If I manage to combine everything in one language, it'll be possible to mix approaches and not use Gc in places where it gets in the way. For example, in the code of the garbage collector itself, and it'll be possible to write the garbage collector in my own language as an external library.
